...
ggplot(filtered_probs_combined, aes(x = reorder(Rank, -Mean_Probability), 
                                     y = Mean_Probability,
                                     fill = Group)) +
  ...
  labs(title = "Symptom Combination Probabilities by Inflammation Status", 
       x = "Symptom Combinations (ranked by average probability)", 
       y = "Probability",
       fill = "") + 
  Theme_Figure_1a
```
