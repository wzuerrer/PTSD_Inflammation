...
# Vectors to track severity before and after matching
...
# NEW: Simulate symptoms with BOTH L and I effects (additive model)
  ...
  W1 <- rescale(0.6 * L + 0.4 * I + rnorm(n, mean=2, sd=1))
...
# I is the "treatment" variable, total_severity is the matching variable
